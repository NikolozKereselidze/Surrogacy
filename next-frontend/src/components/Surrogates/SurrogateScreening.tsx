...
const SurrogateScreening = () => {
    ...
    const processSteps = useMemo(() => t("surrogateScreening.process.steps", {
        returnObjects: true,
    ...
    return (<div className={styles.page} dir={isRTL ? "rtl" : "ltr"}>
      <PageHero id="ss-hero-title" sidebarId="ss-hero-card" translationKey="surrogateScreening.hero" sidebarVariant="simple" primaryHref={`${localePrefix}/who-can-become-a-surrogate`} secondaryHref={`${localePrefix}/surrogacy-in-georgia`}/>
      ...
      <FaqSection id="ss-faq-title" idPrefix="ss-faq" translationKey="surrogateScreening.faq"/>

      <PageCtaSection id="ss-cta-title" translationKey="surrogateScreening.cta" localePrefix={localePrefix} onPrimaryClick={scrollToContact}/>
    </div>);
};

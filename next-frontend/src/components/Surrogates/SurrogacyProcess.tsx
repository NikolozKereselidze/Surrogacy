...
type TimelinePhase = { title: string; description: string };
type SupportCardItem = { title: string; text: string };
...
const SurrogacyProcess = () => {
  ...
  const processSteps = useMemo(
    () =>
      t("surrogacyProcess.process.steps", {
        returnObjects: true,
      }) as ProcessStepItem[],
    [t],
  );
  ...
  const timelinePhases = useMemo(
    () =>
      t("surrogacyProcess.timeline.phases", {
        returnObjects: true,
      }) as TimelinePhase[],
    [t],
  );
  ...
  const supportCards = useMemo(
    () =>
      t("surrogacyProcess.support.cards", {
        returnObjects: true,
      }) as SupportCardItem[],
    [t],
  );
  ...
  return (
    <div className={styles.page} dir={isRTL ? "rtl" : "ltr"}>
      <PageHero
        id="sp-hero-title"
        sidebarId="sp-hero-card"
        translationKey="surrogacyProcess.hero"
      ...
      <FaqSection
        id="sp-faq-title"
        idPrefix="sp-faq"
        translationKey="surrogacyProcess.faq"
      />

      <PageCtaSection
        id="sp-cta-title"
        translationKey="surrogacyProcess.cta"

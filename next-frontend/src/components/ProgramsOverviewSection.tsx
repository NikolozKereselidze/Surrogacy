...
const ProgramsOverviewSection = () => {
    ...
    const programs = useMemo(() => PROGRAMS_CONFIG.map((item) => ({
        ...item,
    ...
    return (<section id="programs" className={`${styles.programsSection} section`}>
      ...
      <div className={styles.programsGrid}>
        {programs.map((program) => {
            ...
            return (<div key={program.href} className={styles.programCard}>
              ...
              <ul className={styles.programFeatures}>
                {program.features.map((feature) => (<li key={feature} className={styles.programFeature}>
              ...
              <div className={styles.programFooter}>
                <Button href={`/${locale}${program.href}`} className={styles.programButton}>
                  {program.buttonText}
                </Button>
              </div>
            </div>);

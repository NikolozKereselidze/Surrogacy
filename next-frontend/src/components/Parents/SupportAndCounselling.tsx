...
const SupportAndCounselling = () => {
  ...
  const serviceCards = useMemo(
    () =>
      t("supportAndCounselling.services.cards", {
        returnObjects: true,
      }) as ServiceCard[],
    [t],
  );
  ...
  const journeySteps = useMemo(
    () =>
      t("supportAndCounselling.journey.steps", {
        returnObjects: true,
      }) as JourneyStep[],
    [t],
  );
  ...
  return (
    <div className={styles.page} dir={isRTL ? "rtl" : "ltr"}>
      <PageHero
        id="sac-hero-title"
        sidebarId="sac-hero-card"
        translationKey="supportAndCounselling.hero"
      ...
      <FaqSection
        id="sac-faq-title"
        idPrefix="sac-faq"
        translationKey="supportAndCounselling.faq"
      />

      <PageCtaSection
        id="sac-cta-title"
        translationKey="supportAndCounselling.cta"

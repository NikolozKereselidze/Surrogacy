...
const ParentScreening = () => {
    ...
    const processSteps = useMemo(() => t("parentScreening.process.steps", {
        returnObjects: true,
    ...
    return (<div className={styles.page} dir={isRTL ? "rtl" : "ltr"}>
      <PageHero id="ps-hero-title" sidebarId="ps-hero-card" translationKey="parentScreening.hero" sidebarVariant="simple" primaryOnClick={scrollToContact} secondaryHref={`${localePrefix}/surrogacy-in-georgia`}/>
      ...
      <FaqSection id="ps-faq-title" idPrefix="ps-faq" translationKey="parentScreening.faq"/>

      <PageCtaSection id="ps-cta-title" translationKey="parentScreening.cta" localePrefix={localePrefix} onPrimaryClick={scrollToContact}/>
    </div>);
};

...
import { FaHeart, FaUserCheck, FaShieldAlt, FaCalendarAlt, FaBaby, FaGraduationCap, FaMapMarkerAlt, FaPhone, FaEnvelope, FaUsers, FaHandshake, FaFileAlt, FaDna, FaHome, FaMoneyBillWave, FaGlobe, FaUserGraduate, FaHeartbeat, } from "react-icons/fa";
                ...
                return [
                    {
                        ...
                        description: t("whoCanBecome.requirements.previousPregnancy.description"),
                    },
                    {
                        icon: FaUserCheck,
                    ...
                    },
                    {
                        ...
                        description: t("whoCanBecome.requirements.availability.description"),
                    },
                    {
            ...
            case "donor":
                return [
                    ...
                    },
                    {
                        ...
                        description: t("whoCanBecome.requirements.geneticHealth.description"),
                    },
                    {
                        icon: FaShieldAlt,
                        title: t("whoCanBecome.requirements.lifestyle.title"),
                ...
                return [
                    {
                        ...
                        description: t("whoCanBecome.requirements.emotionalReadiness.description"),
                    },
                    {
                        icon: FaMoneyBillWave,
                        title: t("whoCanBecome.requirements.financialStability.title"),
                        description: t("whoCanBecome.requirements.financialStability.description"),
                    },
                    {
                        icon: FaHome,
                    ...
                    },
                    {
                        ...
                        description: t("whoCanBecome.requirements.international.description"),
                    },
                    {
                        icon: FaHeartbeat,
                        title: t("whoCanBecome.requirements.healthCommitment.title"),
                        description: t("whoCanBecome.requirements.healthCommitment.description"),
                    },
                ];
            default:
                return [];
    ...
    return (<div className={styles.container}>
      ...
      <section className={`${styles.requirementsSection} section`}>
        ...
        <div className={styles.requirementsGrid}>
          {requirements.map((requirement) => (<RequirementsCard key={requirement.title} icon={requirement.icon} title={requirement.title} description={requirement.description}/>))}
        </div>
      </section>
      ...
      <section className={`${styles.processSection} section`}>
        ...
        <div className="processTimeline">
          {processSteps.map((step) => (<ProcessStep key={step.stepNumber} stepNumber={Number(step.stepNumber)} stepTitle={step.stepTitle} stepContent={step.stepContent} stepIcon={step.stepIcon}/>))}
        </div>
      </section>
      ...
      <section className={`${styles.supportSection} section`}>
        ...
        <div className={styles.supportGrid}>
          <SupportCard title={t(`whoCanBecome.${type}.support.phone.title`)} text={t(`whoCanBecome.${type}.support.phone.text`)} icon={<FaPhone />}/>

          <SupportCard title={t(`whoCanBecome.${type}.support.email.title`)} text={t(`whoCanBecome.${type}.support.email.text`)} icon={<FaEnvelope />}/>

          <SupportCard title={t(`whoCanBecome.${type}.support.coordinator.title`)} text={t(`whoCanBecome.${type}.support.coordinator.text`)} icon={<FaUsers />}/>
        </div>
      </section>
    </div>);
};

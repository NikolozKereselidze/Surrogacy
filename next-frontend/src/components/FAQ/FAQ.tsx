...
import FaqSection, { type FaqSectionItem, } from "@/components/FaqSection/FaqSection";
...
const FAQ = ({ items, categories }: FAQProps) => {
    ...
    return (<FaqSection id="faq-page-title" idPrefix="faq" headingLevel="h1" title={t("faq.title")} subtitle={t("faq.subtitle")} items={resolvedItems} showCategories categories={categories} wide/>);
};
export default FAQ;

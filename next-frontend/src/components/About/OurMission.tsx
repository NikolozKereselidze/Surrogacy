...
const OurMission = () => {
    ...
    return (<div className={styles.ourMissionContainer}>
      ...
      <section className="section">
        ...
        <div className={styles.commitmentGrid}>
          {commitmentCards.map((card, index) => (<RequirementsCard key={index} icon={card.icon} title={card.title} description={card.description}/>))}
        </div>
      </section>
    </div>);
};

...
const localizedMeta = {
    en: {
        ...
        description: "Surrogacy with an egg donor in Georgia country for international intended parents. Donor matching, IVF in Tbilisi, embryo transfer, timelines, and end-to-end support from Happy Family.",
        keywords: [
            ...getMetaKeywords("en"),
    ...
    ka: {
        ...
        description: "სუროგაცია კვერცხუჯრედის დონორით საქართველოში საერთაშორისო მშობლებისთვის. დონორის შერჩევა, ივფ თბილისში, ემბრიონის გადატანა და სრული მხარდაჭერა.",
        keywords: [
            ...getMetaKeywords("ka"),
    ...
    es: {
        ...
        description: "Gestación subrogada con donante de óvulos en Georgia país para padres internacionales. Emparejamiento de donante, FIV en Tiflis, transferencia de embriones y apoyo integral.",
        keywords: [
            ...getMetaKeywords("es"),
    ...
    ru: {
        ...
        description: "Суррогатное материнство с донором яйцеклеток в Грузии для иностранных родителей. Подбор донора, ЭКО в Тбилиси, перенос эмбрионов и комплексная поддержка.",
        keywords: [
            ...getMetaKeywords("ru"),
    ...
    he: {
        ...
        description: "פונדקאות עם תורמת ביציות בגאורגיה להורים בינלאומיים. התאמת תורמת, IVF בטביליסי, העברת עוברים וליווי מקיף מ-Happy Family.",
        keywords: [
            ...getMetaKeywords("he"),
    ...
    zh: {
        ...
        description: "格鲁吉亚供卵代孕，面向国际意向父母。供卵者匹配、第比利斯试管婴儿、胚胎移植及全程支持服务。",
        keywords: [
            ...getMetaKeywords("zh"),
            "格鲁吉亚供卵",
            "格鲁吉亚供卵代孕",

...
const localizedMeta = {
    en: {
        ...
        description: "Learn why to become an egg donor in Georgia: meaningful impact, safe medical care, thorough screening, and supportive guidance from start to finish.",
        keywords: [
    ...
    ka: {
        ...
        description: "გაიგეთ რატომ ღირს კვერცხუჯრედის დონორობა საქართველოში: უსაფრთხო პროცესი, საფუძვლიანი სკრინინგი და მხარდაჭერა ყველა ეტაპზე.",
        keywords: [
    ...
    es: {
        ...
        description: "Descubra por qué convertirse en donante de óvulos en Georgia: impacto significativo, atención médica segura, evaluación exhaustiva y orientación de apoyo.",
        keywords: [
    ...
    he: {
        ...
        description: "למדי למה להפוך לתורמת ביציות בגאורגיה: השפעה משמעותית, טיפול רפואי בטוח, סינון מקיף וליווי תומך מתחילת הדרך ועד סופה.",
        keywords: [
            "למה לתרום ביציות",
    ...
    ru: {
        ...
        description: "Узнайте, почему стоит стать донором яйцеклеток в Грузии: значимый вклад, безопасная медицинская помощь, тщательный скрининг и поддержка на каждом этапе.",
        keywords: [
    ...
    zh: {
        ...
        description: "了解为什么在格鲁吉亚成为卵子捐赠者：意义深远的影响、安全的医疗护理、彻底的筛查以及全程的支持与指导。",
        keywords: [
            "为什么成为卵子捐赠者",
            "格鲁吉亚卵子捐赠",
            "卵子捐赠者",

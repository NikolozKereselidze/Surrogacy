...
const localizedMeta = {
    en: {
        ...
        description: "Surrogate eligibility and requirements in Georgia country: health criteria, screening, legal considerations, compensation overview, and support throughout the surrogacy journey.",
        keywords: [
            ...getMetaKeywords("en"),
    ...
    ka: {
        ...
        description: "სუროგატის უფლებამოსილება და მოთხოვნები საქართველოში: ჯანმრთელობის კრიტერიუმები, სკრინინგი, იურიდიული ასპექტები და მხარდაჭერა მთელი პროცესის განმავლობაში.",
        keywords: [
            ...getMetaKeywords("ka"),
    ...
    es: {
        ...
        description: "Elegibilidad y requisitos para gestantes en Georgia país: criterios de salud, evaluación, consideraciones legales y apoyo durante todo el proceso de subrogación.",
        keywords: [
            ...getMetaKeywords("es"),
    ...
    ru: {
        ...
        description: "Требования к суррогатным матерям в Грузии: медицинские критерии, скрининг, юридические аспекты и поддержка на всех этапах суррогатной программы.",
        keywords: [
            ...getMetaKeywords("ru"),
    ...
    he: {
        ...
        description: "זכאות ודרישות לפונדקאיות בגאורגיה: קריטריוני בריאות, סינון, שיקולים משפטיים ותמיכה לאורך כל תהליך הפונדקאות.",
        keywords: [
            ...getMetaKeywords("he"),
    ...
    zh: {
        ...
        description: "格鲁吉亚代孕妈妈资格与要求：健康标准、筛查流程、法律考量及代孕全程支持服务。",
        keywords: [
            ...getMetaKeywords("zh"),
            "格鲁吉亚代孕妈妈要求",
            "格鲁吉亚代孕",

...
const localizedMeta = {
    en: {
        ...
        description: "Gestational surrogacy using your own eggs and sperm in Georgia country. Eligibility, IVF in Tbilisi, embryo creation and transfer, timelines, and comprehensive support for international intended parents.",
        keywords: [
            ...getMetaKeywords("en"),
    ...
    ka: {
        ...
        description: "გესტაციური სუროგაცია საკუთარი კვერცხუჯრედებითა და სპერმით საქართველოში. უფლებამოსილება, ივფ თბილისში, ემბრიონის შექმნა და გადატანა საერთაშორისო მშობლებისთვის.",
        keywords: [
            ...getMetaKeywords("ka"),
    ...
    es: {
        ...
        description: "Gestación subrogada con óvulos y esperma propios en Georgia país. Elegibilidad, FIV en Tiflis, creación y transferencia de embriones para padres internacionales.",
        keywords: [
            ...getMetaKeywords("es"),
    ...
    ru: {
        ...
        description: "Гестационное суррогатное материнство с собственными яйцеклетками и спермой в Грузии. ЭКО в Тбилиси, создание и перенос эмбрионов для международных родителей.",
        keywords: [
            ...getMetaKeywords("ru"),
    ...
    he: {
        ...
        description: "פונדקאות גסטציונלית עם ביציות וזרע עצמיים בגאורגיה. זכאות, IVF בטביליסי, יצירת והעברת עוברים וליווי מקיף להורים בינלאומיים.",
        keywords: [
            ...getMetaKeywords("he"),
    ...
    zh: {
        ...
        description: "格鲁吉亚自卵自精妊娠代孕。资格评估、第比利斯试管婴儿、胚胎创建与移植，为国际意向父母提供全程支持。",
        keywords: [
            ...getMetaKeywords("zh"),
            "格鲁吉亚自卵代孕",
            "格鲁吉亚试管婴儿",

...
const localizedMeta = {
    en: {
        ...
        description: "Egg donor eligibility in Georgia country: age and health criteria, screening steps, commitment overview, and supportive guidance from application through donation.",
        keywords: [
            ...getMetaKeywords("en"),
    ...
    ka: {
        ...
        description: "კვერცხუჯრედის დონორის უფლებამოსილება საქართველოში: ასაკი და ჯანმრთელობის კრიტერიუმები, სკრინინგი და მხარდაჭერა განაცხადიდან დონაციამდე.",
        keywords: [
            ...getMetaKeywords("ka"),
    ...
    es: {
        ...
        description: "Elegibilidad para donantes de óvulos en Georgia país: criterios de edad y salud, evaluación, compromiso y orientación de apoyo desde la solicitud hasta la donación.",
        keywords: [
            ...getMetaKeywords("es"),
    ...
    ru: {
        ...
        description: "Требования к донорам яйцеклеток в Грузии: возраст и здоровье, этапы скрининга, обязательства и поддержка от заявки до донации.",
        keywords: [
            ...getMetaKeywords("ru"),
    ...
    he: {
        ...
        description: "זכאות לתורמות ביציות בגאורגיה: קריטריוני גיל ובריאות, שלבי סינון, התחייבות וליווי תומך מהגשת הבקשה ועד התרומה.",
        keywords: [
            ...getMetaKeywords("he"),
    ...
    zh: {
        ...
        description: "格鲁吉亚卵子捐赠者资格要求：年龄与健康标准、筛查步骤、承诺说明及从申请到捐赠的全程支持。",
        keywords: [
            ...getMetaKeywords("zh"),
            "格鲁吉亚供卵要求",
            "格鲁吉亚供卵",

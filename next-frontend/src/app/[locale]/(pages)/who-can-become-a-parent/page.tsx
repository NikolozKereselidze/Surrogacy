...
const localizedMeta = {
    en: {
        ...
        description: "Eligibility for intended parents pursuing surrogacy in Georgia country. Documentation, screening, legal requirements, and steps to begin your family-building journey in Tbilisi.",
        keywords: [
            ...getMetaKeywords("en"),
    ...
    ka: {
        ...
        description: "მშობლობის კანდიდატების უფლებამოსილება სუროგაციის პროგრამაში საქართველოში. დოკუმენტაცია, სკრინინგი, იურიდიული მოთხოვნები და პირველი ნაბიჯები.",
        keywords: [
            ...getMetaKeywords("ka"),
    ...
    es: {
        ...
        description: "Elegibilidad para padres de intención en programas de subrogación en Georgia país. Documentación, evaluación, requisitos legales y primeros pasos en Tiflis.",
        keywords: [
            ...getMetaKeywords("es"),
    ...
    ru: {
        ...
        description: "Требования для будущих родителей в программах суррогатного материнства в Грузии. Документы, скрининг, юридические требования и первые шаги в Тбилиси.",
        keywords: [
            ...getMetaKeywords("ru"),
    ...
    he: {
        ...
        description: "זכאות להורים מיועדים בתוכניות פונדקאות בגאורגיה. מסמכים, סינון, דרישות משפטיות והצעדים הראשונים בדרך לבניית משפחה בטביליסי.",
        keywords: [
            ...getMetaKeywords("he"),
    ...
    zh: {
        ...
        description: "格鲁吉亚代孕项目中意向父母的资格要求。文件准备、筛查流程、法律要求及在第比利斯开启家庭之旅的第一步。",
        keywords: [
            ...getMetaKeywords("zh"),
            "格鲁吉亚代孕资格",
            "格鲁吉亚代孕",

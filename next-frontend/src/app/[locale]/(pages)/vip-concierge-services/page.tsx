...
const localizedMeta = {
  en: {
    ...
    description:
      "VIP concierge for international intended parents in Georgia country: premium housing, translation, transportation, and 24/7 white-glove support throughout your surrogacy journey in Tbilisi.",
    keywords: [
      ...getMetaKeywords("en"),
  ...
  ka: {
    ...
    description:
      "VIP კონსიერჟი საერთაშორისო მშობლებისთვის საქართველოში: პრემიუმ საცხოვრებელი, თარგმანი, ტრანსპორტირება და 24/7 მხარდაჭერა თბილისში.",
    keywords: [
      ...getMetaKeywords("ka"),
      "VIP კონსიერჟი",
  ...
  es: {
    ...
    description:
      "Conserjería VIP para padres internacionales en Georgia país: alojamiento premium, traducción, transporte y apoyo 24/7 durante su viaje de subrogación en Tiflis.",
    keywords: [
      ...getMetaKeywords("es"),
  ...
  ru: {
    ...
    description:
      "VIP-консьерж для иностранных родителей в Грузии: премиальное жильё, перевод, транспорт и круглосуточная поддержка на протяжении суррогатной программы в Тбилиси.",
    keywords: [
      ...getMetaKeywords("ru"),
  ...
  he: {
    ...
    description:
      "קונסיירז' VIP להורים בינלאומיים בגאורגיה: לינה פרימיום, תרגום, הסעות ותמיכה 24/7 לאורך מסע הפונדקאות בטביליסי.",
    keywords: [
      ...getMetaKeywords("he"),
  ...
  zh: {
    ...
    description:
      "为格鲁吉亚国际意向父母提供VIP礼宾服务：优质住宿、翻译、交通及24/7全程协助，覆盖第比利斯代孕之旅的每个环节。",
    keywords: [
      ...getMetaKeywords("zh"),
      "格鲁吉亚代孕礼宾",
      "格鲁吉亚代孕",
